export const portfolioData = {
  ...
  about: {
    ...
    skills: {
        front: ["React", "Svelte", "BootStrap", "Tailwind CSS"],
        back: [ "Python", "Java", "Node.js", "C#"],
        mobile: ["Flutter"],
        devops: ["RabbitMQ", "Grafana", "Git", "Docker"],
        bancos: ["MySQL", "PostgreSQL", "MongoDB", "Oracle"]
    },
    filosofia: '"Não tenha sonhos, tenha objetivos."',
    interesses: [`Automação Residencial`,`Impressão 3D`,`Inovação Tecnológica`]
    
  },
  contact: {
    email: "ritzelarthur@gmail.com.com",
